//! grading_rgb_curve op (TODO: port from OCIO).

use crate::config::Config;
use crate::context::Context;
use crate::error::{Error, Result};
use crate::ops::OpVec;
use crate::transforms::{BuildOps, Validate, GradingRgbCurveTransform};
...
impl BuildOps for GradingRgbCurveTransform {
    fn build_ops(&self, _ops: &mut OpVec, _config: &Config, _context: &Context, _dir: TransformDirection) -> Result<()> {
        Err(Error::msg("GradingRgbCurveTransform: not implemented"))
    }
}
